...
const Home = () => {
    return (
        <>
            <section className='pb-20 lg:pb-0 pt-4 h-full w-full'>
                <div className='flex flex-col sm:flex-col lg:flex-row lg:justify-between md:gap-5'>
                    <div className='w-full lg:w-2/3 flex flex-col items-start py-36'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <Link to={'/signin'}>
                                <Button type='button' className='py-3' variant='primary' iconType='trailing' Icon={ArrowRight}>Get Started</Button>
                            </Link>
                        </div>
                    </div>
